...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.5, 574.0, 49.0, 49.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 64.0, 455.0, 77.0, 20.0 ],
					"text" : "route digital"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 11,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 64.0, 504.0, 154.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 84.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 167.0, 53.982315, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 223.0, 104.0, 21.0 ],
					"text" : "pak pinMode 9 ０"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-65",
					"items" : [ "select...", ",", "MacBookPro-Bluetooth-In", ",", "104-Bluetooth-PDA-Sync", ",", "Bluetooth-Modem", ",", "Bluetooth-Incoming-Port", ",", "1-18-Bluetooth-Incoming", ",", "UEBOOM-LWACP", ",", "usbmodem1411" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 64.0, 395.0, 58.0, 21.0 ],
					"text" : "maxuino"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 290.0, 80.0, 19.0 ],
					"text" : "pinMode 5 "
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 860.963989, 361.0, 112.5, 361.0 ],
					"source" : [ "obj-62", 0 ]
				}
