...
,
		"rect" : [ 11.0, 54.0, 851.0, 638.0 ],
		"bglocked" : 0,
		"defrect" : [ 11.0, 54.0, 851.0, 638.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "metro 1000",
					"patching_rect" : [ 12.0, 165.0, 81.0, 24.0 ],
					"id" : "obj-21",
					"fontname" : "Osaka",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "swatch",
					"patching_rect" : [ 534.0, 177.0, 274.0, 161.0 ],
					"id" : "obj-19",
					"numinlets" : 3,
					"numoutlets" : 2,
					"compatibility" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "getsize",
					"patching_rect" : [ 248.0, 438.0, 52.0, 22.0 ],
					"id" : "obj-17",
					"fontname" : "Osaka",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 116.0, 438.0, 111.0, 24.0 ],
					"id" : "obj-16",
					"fontname" : "Osaka",
					"numinlets" : 3,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 185.0, 41.0, 35.0, 22.0 ],
					"id" : "obj-9",
					"fontname" : "Osaka",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "400",
					"patching_rect" : [ 97.0, 41.0, 35.0, 22.0 ],
					"id" : "obj-7",
					"fontname" : "Osaka",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 185.0, 95.0, 50.0, 24.0 ],
					"id" : "obj-6",
					"fontname" : "Osaka",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 97.0, 95.0, 50.0, 24.0 ],
					"id" : "obj-5",
					"fontname" : "Osaka",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p drawCircle2",
					"patching_rect" : [ 62.0, 279.0, 88.0, 24.0 ],
					"id" : "obj-23",
					"fontname" : "Osaka",
					"numinlets" : 3,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"triscale" : 0.9,
					"minimum" : 0.5,
					"patching_rect" : [ 322.0, 62.0, 55.0, 24.0 ],
					"id" : "obj-129",
					"fontname" : "Osaka",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "qmetro 30",
					"patching_rect" : [ 267.0, 164.0, 74.0, 24.0 ],
					"id" : "obj-131",
					"fontname" : "Osaka",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.lcd",
					"patching_rect" : [ 62.0, 463.0, 42.0, 24.0 ],
					"id" : "obj-2",
					"fontname" : "Osaka",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 504.0, 74.5, 123.0, 24.0 ],
					"id" : "obj-43",
					"fontname" : "Osaka",
					"numinlets" : 4,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p setLCDSIze",
					"patching_rect" : [ 508.0, 30.5, 104.0, 24.0 ],
					"id" : "obj-34",
					"fontname" : "Osaka",
					"numinlets" : 0,
					"numoutlets" : 3,
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-23", 0 ],
					"hidden" : 0,
					"midpoints" : [ 21.5, 233.5, 71.5, 233.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-21", 0 ],
					"hidden" : 0,
					"midpoints" : [ 44.5, 127.0, 21.5, 127.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-20", 0 ],
					"hidden" : 0,
					"midpoints" : [ 543.5, 365.0, 405.5, 365.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 257.5, 500.0, 71.5, 500.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 125.5, 515.0, 71.5, 515.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 194.5, 179.0, 217.5, 179.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-16", 1 ],
					"hidden" : 0,
					"midpoints" : [ 106.5, 140.0, 171.5, 140.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-23", 2 ],
					"hidden" : 0,
					"midpoints" : [ 194.5, 157.0, 140.5, 157.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 276.5, 366.0, 71.5, 366.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 44.5, 83.0, 276.5, 83.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 513.5, 334.0, 71.5, 334.0 ]
				}
